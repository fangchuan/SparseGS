...
class SparseGSGaussianModel:
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, spatial_lr_scale : float):
        ...
        print(f"[create_from_pcd] fused_color shape : {fused_color.shape}")
        ...
        opacities = 0.8 * torch.ones((fused_point_cloud.shape[0], 1), dtype=torch.float, device="cuda")
