...
DATA_DIR=/data-nas/experiments/zhenqing/diffsplat/out/test_sd15_8rgbsscm_warp_512/Text23D_exp_spatialgen_16view
# List of scenes
spatialgen_scenes=(
...
for i in "${!spatialgen_scenes[@]}"; do
    ...
    python3 train.py \
        ...
        --model_path sparseradegs_out/Text23D_exp_spatialgen_16view/${scene}_lpips_radegs \
        --beta 5.0 \
        --lambda_pearson 0.05 \
