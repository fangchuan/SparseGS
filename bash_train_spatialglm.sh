...
DATA_DIR=/data-nas/experiments/zhenqing/diffsplat/out/Img23D_exp_spatiallm/Img23D_exp_spatiallm_16view
# List of scenes
spatialgen_scenes=(
    "L1D0S132B0ENDPKVV3EAUWIIDELUFX7HQFHA8_1"
...
for i in "${!spatialgen_scenes[@]}"; do
    ...
    python3 train.py \
        ...
        --model_path sparseradegs_out/Img23D_exp_spatiallm_16view/${scene}_lpips_radegs \
        --beta 5.0 \
        --lambda_pearson 0.05 \
